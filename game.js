...
getNewQuestion = () => {
   ...
   questionCounter++;
   progressText.innerText = "Question " +(questionCounter + "/" + MAX_QUESTIONS); // display the question number from average max 
   // update progress Bar
   progressBarfull.style.width = (( questionCounter / MAX_QUESTIONS) * 100) ;  // '${(questionCounter / MAX_QUESTIONS) * 100}%'
